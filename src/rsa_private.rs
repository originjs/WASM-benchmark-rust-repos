...
impl RsaPrivate {
    ...
    #[wasm_bindgen(js_name = getPrivateKeyPem)]
    pub fn get_privat_key_pem(&self) -> String {
        self.pri_pem.clone()
    }

    // TODO: der generated by this func cannot be verified by openssl
    #[wasm_bindgen(js_name = getPrivateKeyDer)]
...
mod rsa_private_tests {
    ...
    #[test]
    fn can_get_private_key_content() {
        let rsa_private = RsaPrivate::new(Some(1024), None);
        assert_ne!(rsa_private.get_privat_key_pem(), String::from(""));
        assert_ne!(rsa_private.get_private_key_der(), Vec::<u8>::new());
    }
